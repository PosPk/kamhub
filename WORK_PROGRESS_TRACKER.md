...
- [ ] **Маршрут** (откуда → куда) с координатами
- [ ] **Количество человек** (1-50+)
- [ ] **Тип транспорта** (эконом/комфорт/бизнес/микроавтобус/автобус)
- [ ] **Дополнительные требования** (багаж, инвалидность, детские кресла)
- [ ] **Бюджет** (диапазон цен)

#### 🤝 **ПРОЦЕСС ПОДТВЕРЖДЕНИЯ:**
- [ ] **Отправка запроса** всем подходящим перевозчикам
- [ ] **Уведомления** перевозчикам (SMS/Email/Telegram)
- [ ] **Время ответа** 15-30 минут
- [ ] **Автоматический отказ** при неответе
- [ ] **Приоритизация** по рейтингу и цене

#### 🎯 **СПЕЦИФИКА ТУРИСТИЧЕСКИХ ТРАНСФЕРОВ:**
- [ ] **Групповые перевозки** (до 50+ человек)
- [ ] **Координация с турами** (встреча в аэропорту, доставка к началу тура)
- [ ] **Багаж и снаряжение** (лыжи, рюкзаки, фотоаппаратура)
- [ ] **Специальные требования** (инвалидные коляски, детские кресла)
- [ ] **Гибкие маршруты** (остановки для фото, покупок)
- [ ] **Многоязычные водители** (английский, китайский, японский)
...
2. [ ] Реализовать API поиска трансферов
3. [ ] Создать компонент поиска
4. [ ] Интегрировать с дашбордом туриста

### 🟠 **ВЫСОКИЕ (ЗАВТРА):**
1. [ ] API бронирования
2. [ ] Дашборд перевозчика
